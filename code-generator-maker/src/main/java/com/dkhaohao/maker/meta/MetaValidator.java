...
import com.dkhaohao.maker.meta.enums.ModelTypeEnum;
...
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "dkhaohao");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "com.dkhaohao");
